...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <form name="search" class="navbar-form navbar-left" action="Search" method="post" onsubmit="return validateSearch()">
      <div class="form-group">
        <input type="text" class="form-control" placeholder="Search user by first name" name= "firstname">
      </div>
      <button onclick="validateSearch()" type="submit" class="btn btn-default">Submit</button>
    </form>
  </div>
</nav>	
